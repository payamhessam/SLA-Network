...
app = FastAPI(title="Enterprise Network Health and SLA", version="1.1.0",
...
def health(db: Session = Depends(session)):
    ...
    return {"status":"ok", "database":"connected", "logicmonitor":"configured" if settings.lm_portal_url else "not configured", "version":"1.1.0"}
