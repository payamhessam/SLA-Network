...
The application builds dedicated project images named `medline-enterprise-network-sla-api:1.1.0` and `medline-enterprise-network-sla-web:1.1.0`. It does not reuse application images from other projects. See `CHANGELOG.md` for the version history.
