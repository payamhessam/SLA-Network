...
docker tag medline-enterprise-network-sla-api:1.0.0 sla-network-api:1.0.0
docker tag medline-enterprise-network-sla-web:1.0.0 sla-network-web:1.0.0
docker save sla-network-api:1.0.0 -o "$Out\images\api.tar"
docker save sla-network-web:1.0.0 -o "$Out\images\web.tar"
docker save postgres:16.9-alpine3.22 -o "$Out\images\postgres.tar"
docker rmi sla-network-api:1.0.0 sla-network-web:1.0.0 | Out-Null
...
Images: sla-network-api:1.0.0, sla-network-web:1.0.0, postgres:16.9-alpine3.22
