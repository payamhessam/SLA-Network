...
function TelemetryPage(){
  ...
  return <div className="ov">
    ...
    <div className="ov-panel-head" style={{background:'transparent',border:0,padding:'0 0 8px'}}><h2 style={{textTransform:'none',fontFamily:'var(--ov-sans)',fontSize:16,fontWeight:700}}>Interface / Circuit Health<Help text="Fleet-wide interface status from SNMP: total interfaces, operational (up), down while admin-up, high utilisation (≥80%), interfaces with tx/rx errors, and flapping links. The issues table lists the worst offenders."/></h2></div>
    {tiles([['Interfaces',iface.total,'total',false],['Up',iface.up,'operational',false],['Down',iface.down,'admin-up but down',iface.down>0],['High util',iface.high_util,'≥80%',iface.high_util>0],['With errors',iface.with_errors,'tx/rx',iface.with_errors>0],['Flapping',iface.flapping,'flaps>0',iface.flapping>0]])}
